...
export default function ArtistPromotionPaymentPage() {
  const [user, setUser] =
        ...
        !submission ? (
          <section className="mt-8 rounded-[2rem] border border-white/10 bg-white/[0.035] p-8 text-center">
            ...
            <p className="mt-3 text-white/55">
              An owner must approve a promotion submission before payment.
            </p>
            <Link
              href="/artist-promotion"
              className="mt-6 inline-flex rounded-2xl bg-white px-6 py-4 font-black text-black"
              ...
              {clientId ? (
                ...
                >
                  <PayPalButtons
                    ...
                    onError={(error) => {
                      console.error(
                        "Artist promotion PayPal error:",
                        error
                      );

                      setErrorMessage(
                        "PayPal could not complete the promotion payment."
                      );
                    }}
                  />
                </PayPalScriptProvider>
