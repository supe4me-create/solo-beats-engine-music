...
export async function POST(
  ...
  try {
      ...
      return NextResponse.json(
        {
          success: false,
          error:
            "Choose an image for Image to Video.",
        },
        {
          status: 400,
        }
      ...
      return NextResponse.json(
        {
          success: false,
          error:
            "The image must be 16 MB or smaller.",
        },
        {
          status: 400,
        }
      ...
      return NextResponse.json(
        {
          success: false,
          error:
            "This job does not support a source image.",
        },
        {
          status: 400,
        }
    ...
    console.error(
      "AI video source image upload error:",
      error
    );
