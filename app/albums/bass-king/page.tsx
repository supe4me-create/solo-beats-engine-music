export default function BassKingPage() {
  return (
    <main className="min-h-screen bg-black text-white flex items-center justify-center">
      <div className="max-w-2xl text-center">
        ...
        <img
          src="/covers/bassking.png"
          alt="Bass King"
          className="w-80 mx-auto rounded-2xl shadow-2xl"
        />

        <h1 className="text-5xl font-bold mt-8">Bass King</h1>

        <p className="text-gray-400 mt-4">2026 • 20 Tracks</p>

        <audio controls className="w-full mt-8">
          <source src="/previews/bassking.wav" type="audio/wav" />
        </audio>
