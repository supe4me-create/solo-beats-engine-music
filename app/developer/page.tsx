        ...
        <section className="mt-8 rounded-[2rem] border border-cyan-300/15 bg-gradient-to-br from-cyan-500/10 via-white/[0.035] to-violet-500/10 p-6 sm:p-8">
          ...
          <div className="mt-8">
            ...
            <div className="mt-5 grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
              ...
              <ManagementLink
                title="Homepage Manager"
                description="Preview and manage the public homepage from one dashboard. Review the flagship album, Homepage Video Channel, promotions, featured content, albums, banners, and homepage section status in the same order visitors see them."
                href="/developer/homepage"
                action="Open Homepage Manager"
            ...
            <div className="mt-5 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
              <ManagementLink
                ...
                loadingCampaigns
                  ...
                  : `${artistCampaignCounts.total} total Â· ${artistCampaignCounts.pending} pending Â· ${artistCampaignCounts.awaitingPayment} awaiting payment Â· ${artistCampaignCounts.readyToSchedule} ready Â· ${artistCampaignCounts.scheduled} scheduled Â· ${artistCampaignCounts.activeNow} active now`
              }
                href="/developer/artist-promotions"
                action="Manage Promotions"
                badge="Promotion"
              ...
              <ManagementLink
                ...
                loadingCampaigns
                  ...
                  : `${businessCampaignCounts.total} total Â· ${businessCampaignCounts.pending} pending Â· ${businessCampaignCounts.awaitingPayment} awaiting payment Â· ${businessCampaignCounts.readyToSchedule} ready Â· ${businessCampaignCounts.scheduled} scheduled Â· ${businessCampaignCounts.activeNow} active now`
              }
                href="/developer/business-advertising"
                action="Manage Advertising"
                badge="Advertising"
